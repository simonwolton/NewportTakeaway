...
else die("You do not have permission to access this part of the site!");
		...
		<div id="wrapper">
			...
			<div id="main">
				<div id="content">
					...
					$allOrdersQR = mysql_query("SELECT * FROM `orders` WHERE userID = $_SESSION[loggedInUserID] AND date IS NOT NULL");
					if (!(mysql_num_rows($allOrdersQR)))
						echo "You've not ordered anything. Maybe you forgot to check out your basket?";
					else
					{
