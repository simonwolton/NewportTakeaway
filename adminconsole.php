			...
			<div id="main">
				<div id="content">
					<div class='centeredContent'>
						<a href="addmenuitem.php"><img src='images/add.png'/>Add menu item</a><br />
						<a href="menu.php" class='centeredContent'><img src='images/edit.png'/>Edit menu item</a><br />
						<a href="viewallorders.php" class='centeredContent'><img src='images/list.png'/>View all orders</a><br />
						<a href="viewallusers.php" class='centeredContent'><img src='images/user.png'/>View all users</a><br />
					</div>
