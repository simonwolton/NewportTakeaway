			...
			<div id="main">
				<div id="content" style="text-align:center;">
					...
					if ($_SERVER["REQUEST_METHOD"] == "POST") // If anything was posted here, do this...
					{
						...
						$success = mysql_query("UPDATE `orders` SET date='" . date('Y-m-d H:i:s', time()) . "',orderPrice='$_POST[orderPrice]' WHERE orderID = $_POST[orderID];");
						// Update current basket with timestamp and total price
						
						mysql_query("INSERT INTO `orders` (userID) VALUES ('$_SESSION[loggedInUserID]');"); // Give the user another empty basket
						if ($success == true)
							echo "Thank you for your custom! Please come again! " . header( 'refresh:3;url=index.php' );
						mysql_close($connection);
					}
					else echo "Didn't you click checkout?";
